...
def main():
    ...
    print('test fichier')
    #parser.add_argument('Input Path', help='The path to the image to convert. A .si2 will be converted to a .png file. Any other image type will be converted to a .si2 file.', default='/home/elisee/Téléchargements/')
    #parser.add_argument('Output Path', help='The path to output the converted image to.', default='/home/elisee/Téléchargements/')
    print('test fichier bon')

    args = vars(parser.parse_args()) 
    print('premier bon')
    source = '/home/andy/Bureau/CASALISHOOTER/MinGL2/tools/casalihearder3(1).png'
    print('second bon')
    output = '/home/andy/Bureau/build-CASALISHOOTER-Desktop_Qt_6_2_1_GCC_64bit-Debug/img/casaliheader.si2'
    print('test source et output bon')
